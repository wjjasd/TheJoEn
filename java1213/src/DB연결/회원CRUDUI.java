	...
	public static void main(String[] args) {
		...
		read.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MemberDAO memdao = new MemberDAO();
				try {
					MemberVO memberVO = memdao.read(id,pw);
					
					if(memberVO!=null) {
						
						t1.setText(memberVO.getId());
						t2.setText(memberVO.getPw());
						t3.setText(memberVO.getName());
						t4.setText(memberVO.getTel());
		...
		update.setBounds(256, 326, 97, 41);
		...
		delete.setBounds(375, 326, 97, 41);
